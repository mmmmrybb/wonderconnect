...
function IconInfoOutline({ size = 11, className = "", style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return <span className={`material-symbols-sharp select-none leading-none ${className}`} style={{ fontSize: size, ...symbolStyle, ...style }}>info</span>;
}

function IconVisibilityOffOutline({ size = 14, className = "", style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return <span className={`material-symbols-sharp select-none leading-none ${className}`} style={{ fontSize: size, ...symbolStyle, ...style }}>visibility_off</span>;
}
